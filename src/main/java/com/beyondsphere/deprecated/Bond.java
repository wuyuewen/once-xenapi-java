...
//		 * bond, and which will receive all configuration/VLANs/VIFs on the bond
//		 * if the bond is destroyed
//		 */
...
//	 */
//	public Bond.Record getRecord(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 */
//	public static Bond getByUuid(Connection c, String uuid) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return value of the field
//	 */
//	public PIF getMaster(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return value of the field
//	 */
//	public Set<PIF> getSlaves(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return value of the field
//	 */
//	public Map<String, String> getOtherConfig(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return value of the field
//	 */
//	public PIF getPrimarySlave(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return value of the field
//	 */
//	public Types.BondMode getMode(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 *            New value to set
//	 */
//	public void setOtherConfig(Connection c, Map<String, String> otherConfig) throws BadServerResponse,
...
//	 *            Value to add
//	 */
//	public void addToOtherConfig(Connection c, String key, String value) throws BadServerResponse, XenAPIException,
//			XmlRpcException {
...
//	 * field of the given Bond. If the key is not in that Map, then do nothing.
//	 *
//	 * @param key
//	 *            Key to remove
//	 */
//	public void removeFromOtherConfig(Connection c, String key) throws BadServerResponse, XenAPIException,
//			XmlRpcException {
...
//	 * @param MAC
//	 *            The MAC address to use on the bond itself. If this parameter
//	 *            is the empty string then the bond will inherit its MAC address
//	 *            from the primary slave.
//	 * @param mode
//	 *            Bonding mode to use for the new bond
//	 * @return Task
//	 */
//	public static Task createAsync(Connection c, Network network, Set<PIF> members, String MAC, Types.BondMode mode)
...
//				Marshalling.toXMLRPC(members), Marshalling.toXMLRPC(MAC), Marshalling.toXMLRPC(mode) };
//		Object result = c.dispatch(method_call, method_params).get("Value");
...
//	 */
//	public static Bond create(Connection c, Network network, Set<PIF> members, String MAC, Types.BondMode mode)
//			throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return Task
//	 */
//	public Task destroyAsync(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 * @return Task
//	 */
//	public Task setModeAsync(Connection c, Types.BondMode value) throws BadServerResponse, XenAPIException,
//			XmlRpcException {
...
//	 *            The new bond mode
//	 */
//	public void setMode(Connection c, Types.BondMode value) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//	 */
//	public static Set<Bond> getAll(Connection c) throws BadServerResponse, XenAPIException, XmlRpcException {
...
//
//	/**
//	 * Return a map of Bond references to Bond records for all Bonds known to
//	 * the system.
//	 *
//	 * @return records of all objects
//	 */
//	public static Map<Bond, Bond.Record> getAllRecords(Connection c) throws BadServerResponse, XenAPIException,
//			XmlRpcException {
