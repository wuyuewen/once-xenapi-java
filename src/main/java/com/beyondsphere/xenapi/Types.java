...
import com.beyondsphere.deprecated.User;
...
public class Types {
	...
	public static class BadServerResponse extends XenAPIException {
		public BadServerResponse(Map response) {
			super(ObjectArrayToStringArray((Object[]) response
	...
	/*
	 * A call has been made which should not be made against this version of
	 * host. Probably the host is out of date and cannot handle this call, or is
	 * unable to comply with the details of the call. For instance SR.create on
	 * Miami (4.1) hosts takes an smConfig parameter, which must be an empty map
	...
	/**
	 * Checks the provided server response was successful. If the call failed,
	 * throws a XenAPIException. If the server returned an invalid response,
	 * throws a BadServerResponse. Otherwise, returns the server response as
	 * passed in.
	 * 
	 * In beyondSphere, we just define VmNotFound, UniqueUuidError,
	 * UniqueNameError, RESTORE_TARGET_MISSING_DEVICE. Others should be removed.
	 */
	static Map checkResponse(Map response) throws XenAPIException,
		...
		if (response.get("Status").equals("Failure")) {
			String[] ErrorDescription = ObjectArrayToStringArray((Object[]) response
					.get("ErrorDescription"));
			for(String e : ErrorDescription)
				System.out.println(e);
			if (ErrorDescription[0].equals("VM_NOT_FOUND")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				throw new Types.VmNotFound(p1);
			}
			if (ErrorDescription[0].equals("UNIQUE_UUID_ERROR")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				throw new Types.UniqueUuidError(p1);
			}
			if (ErrorDescription[0].equals("UNIQUE_NAME_ERROR")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				throw new Types.UniqueNameError(p1);
			}
			...
			if (ErrorDescription[0]
					.equals("CANNOT_DESTROY_DISASTER_RECOVERY_TASK")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_ENABLE_FAILED_INVALID_OU")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("IMPORT_ERROR_SOME_CHECKSUMS_FAILED")) {
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_DISABLE_FAILED_PERMISSION_DENIED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("HA_HEARTBEAT_DAEMON_STARTUP_FAILED")) {
			...
			if (ErrorDescription[0]
					.equals("XEN_VSS_REQ_ERROR_CREATING_SNAPSHOT_XML_STRING")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_ENABLE_FAILED_DUPLICATE_HOSTNAME")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_JOINING_HOST_MUST_HAVE_PHYSICAL_MANAGEMENT_NIC")) {
			...
			if (ErrorDescription[0]
					.equals("WLB_XENSERVER_AUTHENTICATION_FAILED")) {
			...
			if (ErrorDescription[0]
					.equals("PATCH_PRECHECK_FAILED_UNKNOWN_ERROR")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("IMPORT_ERROR_ATTACHED_DISKS_NOT_FOUND")) {
			...
			if (ErrorDescription[0]
					.equals("XEN_VSS_REQ_ERROR_CREATING_SNAPSHOT")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("VM_SNAPSHOT_WITH_QUIESCE_NOT_SUPPORTED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("VM_SNAPSHOT_WITH_QUIESCE_PLUGIN_DEOS_NOT_RESPOND")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_JOINING_EXTERNAL_AUTH_MISMATCH")) {
			...
			if (ErrorDescription[0]
					.equals("AUTH_DISABLE_FAILED_PERMISSION_DENIED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				throw new Types.AuthDisableFailedPermissionDenied(p1);
			}
			if (ErrorDescription[0]
					.equals("LICENSE_CANNOT_DOWNGRADE_WHILE_IN_POOL")) {
			...
			if (ErrorDescription[0]
					.equals("AUTH_ENABLE_FAILED_DOMAIN_LOOKUP_FAILED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("PROVISION_ONLY_ALLOWED_ON_TEMPLATE")) {
			...
			if (ErrorDescription[0]
					.equals("COULD_NOT_FIND_NETWORK_INTERFACE_WITH_SPECIFIED_DEVICE_NAME_AND_MAC_ADDRESS")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
				throw new Types.CouldNotFindNetworkInterfaceWithSpecifiedDeviceNameAndMacAddress(
						p1, p2);
			}
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_ENABLE_FAILED_PERMISSION_DENIED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_ENABLE_FAILED_DOMAIN_LOOKUP_FAILED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("HA_CONSTRAINT_VIOLATION_NETWORK_NOT_SHARED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("HA_OPERATION_WOULD_BREAK_FAILOVER_PLAN")) {
			...
			if (ErrorDescription[0]
					.equals("DB_UNIQUENESS_CONSTRAINT_VIOLATION")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("XEN_VSS_REQ_ERROR_PREPARING_WRITERS")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("JOINING_HOST_CANNOT_CONTAIN_SHARED_SRS")) {
			...
			if (ErrorDescription[0]
					.equals("VMPP_ARCHIVE_MORE_FREQUENT_THAN_BACKUP")) {
			...
			if (ErrorDescription[0]
					.equals("JOINING_HOST_CANNOT_BE_MASTER_OF_OTHER_HOSTS")) {
			...
			if (ErrorDescription[0]
					.equals("XEN_VSS_REQ_ERROR_START_SNAPSHOT_SET_FAILED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("PATCH_PRECHECK_FAILED_WRONG_SERVER_VERSION")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
				String p3 = ErrorDescription.length > 3 ? ErrorDescription[3]
						: "";
				throw new Types.PatchPrecheckFailedWrongServerVersion(p1, p2,
						p3);
			}
			...
			if (ErrorDescription[0]
					.equals("AUTH_DISABLE_FAILED_WRONG_CREDENTIALS")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("VDI_CONTAINS_METADATA_OF_THIS_POOL")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_ENABLE_FAILED_WRONG_CREDENTIALS")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_JOINING_HOST_MUST_HAVE_SAME_PRODUCT_VERSION")) {
			...
			if (ErrorDescription[0]
					.equals("SLAVE_REQUIRES_MANAGEMENT_INTERFACE")) {
			...
			if (ErrorDescription[0]
					.equals("JOINING_HOST_CANNOT_HAVE_RUNNING_VMS")) {
			...
			if (ErrorDescription[0]
					.equals("JOINING_HOST_CANNOT_HAVE_VMS_WITH_CURRENT_OPERATIONS")) {
			...
			if (ErrorDescription[0]
					.equals("JOINING_HOST_CANNOT_HAVE_RUNNING_OR_SUSPENDED_VMS")) {
				throw new Types.JoiningHostCannotHaveRunningOrSuspendedVms();
			}
			if (ErrorDescription[0]
					.equals("PATCH_PRECHECK_FAILED_PREREQUISITE_MISSING")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("POOL_AUTH_DISABLE_FAILED_WRONG_CREDENTIALS")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("XEN_VSS_REQ_ERROR_NO_VOLUMES_SUPPORTED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
			...
			if (ErrorDescription[0]
					.equals("IMPORT_ERROR_FAILED_TO_FIND_OBJECT")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("AUTH_ENABLE_FAILED_PERMISSION_DENIED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
			...
			if (ErrorDescription[0]
					.equals("RESTORE_TARGET_MGMT_IF_NOT_IN_BACKUP")) {
			...
			if (ErrorDescription[0]
					.equals("XEN_VSS_REQ_ERROR_ADDING_VOLUME_TO_SNAPSET_FAILED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				String p2 = ErrorDescription.length > 2 ? ErrorDescription[2]
						: "";
				throw new Types.XenVssReqErrorAddingVolumeToSnapsetFailed(p1,
						p2);
			}
			...
			if (ErrorDescription[0]
					.equals("HA_POOL_IS_ENABLED_BUT_HOST_IS_DISABLED")) {
			...
			if (ErrorDescription[0]
					.equals("HA_CONSTRAINT_VIOLATION_SR_NOT_SHARED")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				throw new Types.HaConstraintViolationSrNotShared(p1);
			}
			if (ErrorDescription[0]
					.equals("IMPORT_ERROR_CANNOT_HANDLE_CHUNKED")) {
				throw new Types.ImportErrorCannotHandleChunked();
			}
			if (ErrorDescription[0]
					.equals("VM_ATTACHED_TO_MORE_THAN_ONE_VDI_WITH_TIMEOFFSET_MARKED_AS_RESET_ON_BOOT")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
				throw new Types.VmAttachedToMoreThanOneVdiWithTimeoffsetMarkedAsResetOnBoot(
						p1);
			}
			...
			if (ErrorDescription[0]
					.equals("AUTH_ENABLE_FAILED_WRONG_CREDENTIALS")) {
				String p1 = ErrorDescription.length > 1 ? ErrorDescription[1]
						: "";
	...
	public enum OnBoot {
		...
		UNRECOGNIZED,
		/**
		 * When a VM containing this VDI is started, the contents of the VDI are
		 * reset to the state they were in when this flag was last set.
		 */
		RESET,
		/**
		 * Standard behaviour.
	...
	public enum VmPowerState {
		...
		HALTED,
		/**
		 * All resources have been allocated but the VM itself is paused and its
		...
		RUNNING,
		/**
		 * VM state has been saved to disk and it is nolonger running. Note that
		 * disks remain in-use while the VM is suspended.
		 */
		SUSPENDED;
		public String toString() {
			if (this == UNRECOGNIZED)
	 ...
	 */
	public static class CannotDestroyDisasterRecoveryTask extends
			XenAPIException {
	...
	/**
	 * The SR.shared flag cannot be set to false while the SR remains connected
	 * to multiple hosts
	 */
	...
	/**
	 * This operation needs the OpenVSwitch networking backend to be enabled on
	...
	/**
	 * The patch precheck stage failed: there are one or more VMs still running
	 * on the server. All VMs must be suspended before the patch can be applied.
	 */
	...
	/**
	 * You attempted to run a VM on a host which doesn't have I/O virtualisation
	 * (IOMMU/VT-d) enabled, which is needed by the VM.
	 */
	...
	/**
	 * The operation failed because the HA software on the specified host could
	 * not see a subset of other hosts. Check your network connectivity.
	 */
	 ...
	 * host.
	 */
	public static class PoolAuthDisableFailedPermissionDenied extends
			XenAPIException {
		public final String host;
		public final String message;
	...
	/**
	 * The host could not join the liveset because the HA daemon failed to
	 * start.
	 */
	 ...
	 * in the GPU group needed by the VM. The VM has a vGPU attached to this GPU
	 * group.
	 */
	...
	/**
	 * This operation cannot be performed because this VDI could not be properly
	 * attached to the VM.
	 */
	...
	/**
	 * The master reports that it cannot talk back to the slave on the supplied
	...
	public static class XapiHookFailed extends XenAPIException {
		 ...
		 * @param exitCode
		 */
		public XapiHookFailed(String hookName, String reason, String stdout,
				String exitCode) {
	...
	public static class MapDuplicateKey extends XenAPIException {
		 ...
		 * @param key
		 */
		public MapDuplicateKey(String type, String paramName, String uuid,
				String key) {
			super(
	 ...
	 */
	public static class XenVssReqErrorCreatingSnapshotXmlString extends
			XenAPIException {
		public final String vm;
		public final String errorCode;
		 ...
		 * @param errorCode
		 */
		public XenVssReqErrorCreatingSnapshotXmlString(String vm,
				String errorCode) {
			super(
					"Could not create the XML string generated by the transportable snapshot");
			this.vm = vm;
	...
	/**
	 * The WLB server reported that XenServer said something to it that WLB
	 ...
	 * The pool failed to enable external authentication.
	 */
	public static class PoolAuthEnableFailedDuplicateHostname extends
			XenAPIException {
		public final String host;
		public final String message;
	...
	/**
	 * The SR could not be destroyed, as the 'indestructible' flag was set on
	 * it.
	 */
	...
	/**
	 * The WLB server said something that XenServer wasn't expecting or didn't
	 * understand. The method called on the WLB server, a diagnostic reason, and
	 * the response from WLB are returned.
	 */
	public static class WlbMalformedResponse extends XenAPIException {
		 ...
		 * @param response
		 */
		public WlbMalformedResponse(String method, String reason,
				String response) {
			super(
	...
	/**
	 * The host joining the pool must have a physical management NIC (i.e. the
	 * management NIC must not be on a VLAN or bonded PIF).
	 */
	public static class PoolJoiningHostMustHavePhysicalManagementNic extends
			XenAPIException {
	...
	/**
	 * The WLB server reported that XenServer rejected its configured
	 * authentication details.
	 */
	public static class WlbXenserverAuthenticationFailed extends
			XenAPIException {
	...
	/**
	 * The patch precheck stage failed with an unknown error. See attached info
	 * for more details.
	 */
	...
	/**
	 * Host cannot attach network (in the case of NIC bonding, this may be
	 * because attaching the network on this host would require other networks
	 * [that are currently active] to be taken down).
	 */
	...
	/**
	 * The WLB URL is invalid. Ensure it is in format: <ipaddress>:<port>. The
	 * configured/given URL is returned.
	 */
	...
	/**
	 * This host failed in the middle of an automatic failover operation and
	 ...
	 */
	public static class ImportErrorAttachedDisksNotFound extends
			XenAPIException {
	...
	/**
	 * The WLB server reported that XenServer refused it a connection (even
	 ...
	 */
	public static class VmSnapshotWithQuiesceNotSupported extends
			XenAPIException {
		public final String vm;
	...
	/**
	 * This host cannot join a pool because it's license does not support
	 * pooling
	 */
	...
	/**
	 * The master says the host is not known to it. Perhaps the Host was deleted
	 * from the master's database? Perhaps the slave is pointing to the wrong
	 * master?
	 */
	 ...
	 */
	public static class VmSnapshotWithQuiescePluginDeosNotRespond extends
			XenAPIException {
		public final String vm;
	...
	/**
	 * The WLB server reported that its configured server name for this
	 * XenServer instance failed to resolve in DNS.
	 */
	...
	/**
	 * The host could not join the liveset because the HA daemon could not
	...
	/**
	 * The PBD could not be plugged because the SR is in use by another host and
	 * is not marked as sharable.
	 */
	 ...
	 */
	public static class AuthDisableFailedPermissionDenied extends
			XenAPIException {
		public final String message;
	 ...
	 */
	public static class LicenseCannotDowngradeWhileInPool extends
			XenAPIException {
	...
	/**
	 * The request was rejected because there are too many pending tasks on the
	 * server.
	 */
	 ...
	 */
	public static class AuthEnableFailedDomainLookupFailed extends
			XenAPIException {
		public final String message;
	...
	/**
	 * Could not find a network interface with the specified device name and MAC
	 * address.
	 */
	public static class CouldNotFindNetworkInterfaceWithSpecifiedDeviceNameAndMacAddress
			extends XenAPIException {
		public final String device;
		public final String mac;
		 ...
		 * @param mac
		 */
		public CouldNotFindNetworkInterfaceWithSpecifiedDeviceNameAndMacAddress(
				String device, String mac) {
			super(
	...
	/**
	 * There was an error connecting to the host. the service contacted didn't
	 * reply properly.
	 */
	...
	/**
	 * This operation cannot be performed because the specified VDI could not be
	 * found on the storage substrate
	 */
	 ...
	 * The pool failed to enable external authentication.
	 */
	public static class PoolAuthEnableFailedPermissionDenied extends
			XenAPIException {
		public final String host;
		public final String message;
	...
	/**
	 * The specified VBD device is not recognised: please use a non-negative
	 * integer
	 */
	 ...
	 * The pool failed to enable external authentication.
	 */
	public static class PoolAuthEnableFailedDomainLookupFailed extends
			XenAPIException {
		public final String host;
		public final String message;
		 ...
		 * @param message
		 */
		public PoolAuthEnableFailedDomainLookupFailed(String host,
				String message) {
			super("The pool failed to enable external authentication.");
			this.host = host;
			this.message = message;
	...
	/**
	 * Host cannot rejoin pool because it should have fenced (it is not in the
	 * master's partition)
	 */
	 ...
	 * one of the session.login_ calls. This error does not invalidate the
	...
	/**
	 * This operation cannot be performed because the referenced network is not
	 * properly shared. The network must either be entirely virtual or must be
	 * physically present via a currently_attached PIF on every host.
	 */
	public static class HaConstraintViolationNetworkNotShared extends
			XenAPIException {
		public final String network;
	 ...
	 */
	public static class HaOperationWouldBreakFailoverPlan extends
			XenAPIException {
	 ...
	 * designate a new master or xe patch-clean. Please upload the update again
	 */
	...
	/**
	 * You attempted an operation which would have resulted in duplicate keys in
	 * the database.
	 */
	public static class DbUniquenessConstraintViolation extends XenAPIException {
		 ...
		 * @param value
		 */
		public DbUniquenessConstraintViolation(String table, String field,
				String value) {
			super(
	...
	public static class VmMigrateFailed extends XenAPIException {
		 ...
		 * @param msg
		 */
		public VmMigrateFailed(String vm, String source, String destination,
				String msg) {
	...
	/**
	 * The operation could not be performed because the VBD was not connected to
	 * the VM.
	 */
	 ...
	 */
	public static class JoiningHostCannotContainSharedSrs extends
			XenAPIException {
	...
	/**
	 * The operation could not be performed while the host is still armed; it
	 ...
	 */
	public static class VmppArchiveMoreFrequentThanBackup extends
			XenAPIException {
	 ...
	 */
	public static class JoiningHostCannotBeMasterOfOtherHosts extends
			XenAPIException {
	...
	/**
	 * This host can not be forgotten because there are some user VMs still
	 * running
	 */
	...
	/**
	 * The operation you requested cannot be performed because the specified PIF
	 ...
	 */
	public static class XenVssReqErrorStartSnapshotSetFailed extends
			XenAPIException {
		public final String vm;
		public final String errorCode;
	 ...
	 */
	public static class PatchPrecheckFailedWrongServerVersion extends
			XenAPIException {
		public final String patch;
		 ...
		 */
		public PatchPrecheckFailedWrongServerVersion(String patch,
				String foundVersion, String requiredVersion) {
			super(
					"The patch precheck stage failed: the server is of an incorrect version.");
			this.patch = patch;
	 ...
	 * The host failed to disable external authentication.
	 */
	public static class AuthDisableFailedWrongCredentials extends
			XenAPIException {
		public final String message;
	...
	/**
	 * HA can only be enabled for 2 hosts or more. Note that 2 hosts requires a
	 * pre-configured quorum tiebreak script.
	 */
	 ...
	 * The pool failed to enable external authentication.
	 */
	public static class PoolAuthEnableFailedWrongCredentials extends
			XenAPIException {
		public final String host;
		public final String message;
	...
	/**
	 * Some VMs belonging to the appliance threw an exception while carrying out
	...
	/**
	 * The host joining the pool must have the same product version as the pool
	 * master.
	 */
	public static class PoolJoiningHostMustHaveSameProductVersion extends
			XenAPIException {
	...
	/**
	 * The management interface on a slave cannot be disabled because the slave
	 * would enter emergency mode.
	 */
	public static class SlaveRequiresManagementInterface extends
			XenAPIException {
	...
	/**
	 * The operation attempted is not valid for a VM not exists
	 */
	public static class VmNotFound extends XenAPIException {
		public final String vm;

		/**
		 * Create a new VmNotFound
		 *
		 * @param vm
		 */
		public VmNotFound(String vm) {
			super("The operation attempted is not valid for a VM not exists");
			this.vm = vm;
		}
	...
	/**
	 * The operation attempted is not valid for a UUID already exists
	 */
	public static class UniqueUuidError extends XenAPIException {
		public final String vm;

		/**
		 * Create a new UniqueUuidError
		 *
		 * @param vm
		 */
		public UniqueUuidError(String vm) {
			super(
					"The operation attempted is not valid for a UUID already exists");
			this.vm = vm;
		}
	...
	/**
	 * The operation attempted is not valid for a name label already exists
	 */
	public static class UniqueNameError extends XenAPIException {
		public final String vm;

		/**
		 * Create a new UniqueNameError
		 *
		 * @param vm
		 */
		public UniqueNameError(String vm) {
			super(
					"The operation attempted is not valid for a name label already exists");
			this.vm = vm;
		}
	...
	/**
	 * This operation cannot be performed because the specified VM is protected
	 * by xHA
	 */
	...
	/**
	 * This license file is no longer accepted. Please upgrade to the new
	 * licensing system.
	 */
	 ...
	 */
	public static class JoiningHostCannotHaveVmsWithCurrentOperations extends
			XenAPIException {
	...
	public static class MessageParameterCountMismatch extends XenAPIException {
		 ...
		 * @param received
		 */
		public MessageParameterCountMismatch(String method, String expected,
				String received) {
			super(
	...
	/**
	 * External authentication in this pool is already enabled for at least one
	 * host.
	 */
	 ...
	 */
	public static class JoiningHostCannotHaveRunningOrSuspendedVms extends
			XenAPIException {
	 ...
	 */
	public static class PatchPrecheckFailedPrerequisiteMissing extends
			XenAPIException {
		public final String patch;
		 ...
		 */
		public PatchPrecheckFailedPrerequisiteMissing(String patch,
				String prerequisitePatchUuidList) {
			super(
					"The patch precheck stage failed: prerequisite patches are missing.");
			this.patch = patch;
	...
	/**
	 * This operation could not be performed, because the VM has one or more PCI
	 ...
	 * host.
	 */
	public static class PoolAuthDisableFailedWrongCredentials extends
			XenAPIException {
		public final String host;
		public final String message;
	...
	/**
	 * Cannot forward messages because the host cannot be contacted. The host
	 * may be switched off or there may be network connectivity problems.
	 */
	 ...
	 */
	public static class XenVssReqErrorNoVolumesSupported extends
			XenAPIException {
		public final String vm;
		public final String errorCode;
	...
	/**
	 * The host is its own slave. Please use pool-emergency-transition-to-master
	 * or pool-emergency-reset-master.
	 */
	...
	/**
	 * The operation could not be performed because a redo log is enabled on the
	 * Pool.
	 */
	 ...
	 * The host failed to enable external authentication.
	 */
	public static class AuthEnableFailedPermissionDenied extends
			XenAPIException {
		public final String message;
	...
	/**
	 * The restore could not be performed because the host's current management
	 * interface is not in the backup. The interfaces mentioned in the backup
	 * are:
	 */
	...
	/**
	 * You tried to create a VLAN or tunnel on top of a tunnel access PIF - use
	 * the underlying transport PIF instead.
	 */
	 ...
	 */
	public static class XenVssReqErrorAddingVolumeToSnapsetFailed extends
			XenAPIException {
		public final String vm;
		public final String errorCode;
		 ...
		 * @param errorCode
		 */
		public XenVssReqErrorAddingVolumeToSnapsetFailed(String vm,
				String errorCode) {
			super(
					"Some volumes to be snapshot could not be added to the VSS snapshot set");
			this.vm = vm;
	...
	/**
	 * The restore could not be performed because the restore script failed. Is
	 * the file corrupt?
	 */
	...
	public static class ImportErrorUnexpectedFile extends XenAPIException {
		 ...
		 * @param filenameFound
		 */
		public ImportErrorUnexpectedFile(String filenameExpected,
	...
	public static class AuthAlreadyEnabled extends XenAPIException {
		 ...
		 */
		public AuthAlreadyEnabled(String currentAuthType,
	...
	/**
	 * You attempted an operation that was not allowed. Especially when the
	 * under operation vm is Domain 0.
	 */
	...
	/**
	 * Cannot find a plan for placement of VMs as there are no other hosts
	 * available.
	 */
	...
	/**
	 * The VM cannot be imported unforced because it is either the same version
	 * or an older version of an existing VM.
	 */
	public static class VmToImportIsNotNewerVersion extends XenAPIException {
		 ...
		 */
		public VmToImportIsNotNewerVersion(String vm, String existingVersion,
				String versionToImport) {
			super(
	...
	/**
	 * The system rejected the password change request; perhaps the new password
	 * was too short?
	 */
	...
	/**
	 * The host failed to acquire an IP address on its management interface and
	 * therefore cannot contact the master.
	 */
	...
	/**
	 * This host cannot join the pool because the pool has HA enabled but this
	 * host has HA disabled.
	 */
	public static class HaPoolIsEnabledButHostIsDisabled extends
			XenAPIException {
	 ...
	 */
	public static class HaConstraintViolationSrNotShared extends
			XenAPIException {
		public final String SR;
	 ...
	 */
	public static class VmAttachedToMoreThanOneVdiWithTimeoffsetMarkedAsResetOnBoot
			extends XenAPIException {
		public final String vm;

		/**
		 * Create a new
		 * VmAttachedToMoreThanOneVdiWithTimeoffsetMarkedAsResetOnBoot
		 *
		 * @param vm
		 */
		public VmAttachedToMoreThanOneVdiWithTimeoffsetMarkedAsResetOnBoot(
				String vm) {
			super(
	 ...
	 * The host failed to enable external authentication.
	 */
	public static class AuthEnableFailedWrongCredentials extends
			XenAPIException {
		public final String message;
	...
	public static Date toDate(Object object) {
		...
		try {
			...
			return (new Date(
					(long) (1000 * Double.parseDouble((String) object))));
		}
	}
	...
	public static Types.BondMode toBondMode(Object object) {
		...
		try {
			return BondMode.valueOf(((String) object).toUpperCase().replace(
					'-', '_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.HostAllowedOperations toHostAllowedOperations(
			Object object) {
		if (object == null) {
			return null;
		}
		try {
			return HostAllowedOperations.valueOf(((String) object)
	...
	public static Types.OnBoot toOnBoot(Object object) {
		...
		try {
			return OnBoot.valueOf(((String) object).toUpperCase().replace('-',
					'_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.TaskAllowedOperations toTaskAllowedOperations(
			Object object) {
		if (object == null) {
			return null;
		}
		try {
			return TaskAllowedOperations.valueOf(((String) object)
					.toUpperCase().replace('-', '_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.VbdMode toVbdMode(Object object) {
		...
		try {
			return VbdMode.valueOf(((String) object).toUpperCase().replace('-',
					'_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.VbdType toVbdType(Object object) {
		...
		try {
			return VbdType.valueOf(((String) object).toUpperCase().replace('-',
					'_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.VdiType toVdiType(Object object) {
		...
		try {
			return VdiType.valueOf(((String) object).toUpperCase().replace('-',
					'_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.VmApplianceOperation toVmApplianceOperation(
			Object object) {
		if (object == null) {
			return null;
		}
		try {
			return VmApplianceOperation.valueOf(((String) object).toUpperCase()
					.replace('-', '_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Types.VmppArchiveFrequency toVmppArchiveFrequency(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Types.VmppArchiveTargetType toVmppArchiveTargetType(
			Object object) {
		if (object == null) {
			return null;
		}
		try {
			return VmppArchiveTargetType.valueOf(((String) object)
					.toUpperCase().replace('-', '_'));
		} catch (IllegalArgumentException ex) {
	...
	public static Set<Types.AfterApplyGuidance> toSetOfAfterApplyGuidance(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Set<Types.HostAllowedOperations> toSetOfHostAllowedOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Set<Types.NetworkOperations> toSetOfNetworkOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Set<Types.StorageOperations> toSetOfStorageOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Set<Types.TaskAllowedOperations> toSetOfTaskAllowedOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Set<Types.VmApplianceOperation> toSetOfVmApplianceOperation(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// }
	//
	// public static Set<DataSource.Record> toSetOfDataSourceRecord(Object
	// object) {
	// if (object == null) {
	// return null;
	// }
	...
	public static Map<String, Types.HostAllowedOperations> toMapOfStringHostAllowedOperations(
			Object object) {
		if (object == null) {
			return null;
		}
		...
		for (Map.Entry entry : entries) {
			String key = toString(entry.getKey());
			Types.HostAllowedOperations value = toHostAllowedOperations(entry
					.getValue());
			result.put(key, value);
		}
		return result;
	...
	public static Map<String, Types.NetworkOperations> toMapOfStringNetworkOperations(
			Object object) {
		if (object == null) {
			return null;
		}
		...
		for (Map.Entry entry : entries) {
			String key = toString(entry.getKey());
			Types.NetworkOperations value = toNetworkOperations(entry
					.getValue());
			result.put(key, value);
		}
		return result;
	...
	public static Map<String, Types.StorageOperations> toMapOfStringStorageOperations(
			Object object) {
		if (object == null) {
			return null;
		}
		...
		for (Map.Entry entry : entries) {
			String key = toString(entry.getKey());
			Types.StorageOperations value = toStorageOperations(entry
					.getValue());
			result.put(key, value);
		}
		return result;
	...
	public static Map<String, Types.TaskAllowedOperations> toMapOfStringTaskAllowedOperations(
			Object object) {
		if (object == null) {
			return null;
		}
		...
		for (Map.Entry entry : entries) {
			String key = toString(entry.getKey());
			Types.TaskAllowedOperations value = toTaskAllowedOperations(entry
					.getValue());
			result.put(key, value);
		}
		return result;
	...
	public static Map<String, Types.VbdOperations> toMapOfStringVbdOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<String, Types.VdiOperations> toMapOfStringVdiOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<String, Types.VifOperations> toMapOfStringVifOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<String, Types.VmApplianceOperation> toMapOfStringVmApplianceOperation(
			Object object) {
		if (object == null) {
			return null;
		}
		...
		for (Map.Entry entry : entries) {
			String key = toString(entry.getKey());
			Types.VmApplianceOperation value = toVmApplianceOperation(entry
					.getValue());
			result.put(key, value);
		}
		return result;
	...
	public static Map<String, Types.VmOperations> toMapOfStringVmOperations(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<Types.VmOperations, String> toMapOfVmOperationsString(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// }
	//
	// public static Map<DRTask, DRTask.Record> toMapOfDRTaskDRTaskRecord(Object
	// object) {
	// if (object == null) {
	// return null;
	// }
	...
	// }
	//
	// public static Map<GPUGroup, GPUGroup.Record>
	// toMapOfGPUGroupGPUGroupRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<GPUGroup,GPUGroup.Record> result = new
	// HashMap<GPUGroup,GPUGroup.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	// public static Map<PIFMetrics, PIFMetrics.Record>
	// toMapOfPIFMetricsPIFMetricsRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<PIFMetrics,PIFMetrics.Record> result = new
	// HashMap<PIFMetrics,PIFMetrics.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	public static Map<VBDMetrics, VBDMetrics.Record> toMapOfVBDMetricsVBDMetricsRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<VIFMetrics, VIFMetrics.Record> toMapOfVIFMetricsVIFMetricsRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<VM, Map<String, String>> toMapOfVMMapOfStringString(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// public static Map<VMAppliance, VMAppliance.Record>
	// toMapOfVMApplianceVMApplianceRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<VMAppliance,VMAppliance.Record> result = new
	// HashMap<VMAppliance,VMAppliance.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	// public static Map<VMGuestMetrics, VMGuestMetrics.Record>
	// toMapOfVMGuestMetricsVMGuestMetricsRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<VMGuestMetrics,VMGuestMetrics.Record> result = new
	// HashMap<VMGuestMetrics,VMGuestMetrics.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	public static Map<VMMetrics, VMMetrics.Record> toMapOfVMMetricsVMMetricsRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	public static Map<Console, Console.Record> toMapOfConsoleConsoleRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// public static Map<Crashdump, Crashdump.Record>
	// toMapOfCrashdumpCrashdumpRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<Crashdump,Crashdump.Record> result = new
	// HashMap<Crashdump,Crashdump.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	public static Map<HostCpu, HostCpu.Record> toMapOfHostCpuHostCpuRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// public static Map<HostCrashdump, HostCrashdump.Record>
	// toMapOfHostCrashdumpHostCrashdumpRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<HostCrashdump,HostCrashdump.Record> result = new
	// HashMap<HostCrashdump,HostCrashdump.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	public static Map<HostMetrics, HostMetrics.Record> toMapOfHostMetricsHostMetricsRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// public static Map<HostPatch, HostPatch.Record>
	// toMapOfHostPatchHostPatchRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<HostPatch,HostPatch.Record> result = new
	// HashMap<HostPatch,HostPatch.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	// }
	//
	// public static Map<Message, Message.Record>
	// toMapOfMessageMessageRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<Message,Message.Record> result = new
	// HashMap<Message,Message.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	public static Map<Network, Network.Record> toMapOfNetworkNetworkRecord(
			Object object) {
		if (object == null) {
			return null;
		}
	...
	// public static Map<PoolPatch, PoolPatch.Record>
	// toMapOfPoolPatchPoolPatchRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<PoolPatch,PoolPatch.Record> result = new
	// HashMap<PoolPatch,PoolPatch.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	// }
	//
	// public static Map<Secret, Secret.Record> toMapOfSecretSecretRecord(Object
	// object) {
	// if (object == null) {
	// return null;
	// }
	...
	// }
	//
	// public static Map<Subject, Subject.Record>
	// toMapOfSubjectSubjectRecord(Object object) {
	// if (object == null) {
	// return null;
	// }
	// Map map = (Map) object;
	// Map<Subject,Subject.Record> result = new
	// HashMap<Subject,Subject.Record>();
	// Set<Map.Entry> entries = map.entrySet();
	// for(Map.Entry entry: entries) {
	...
	// public static Map<Tunnel, Tunnel.Record> toMapOfTunnelTunnelRecord(Object
	// object) {
	// if (object == null) {
	// return null;
	// }
	...
	// record.currentlyAttached = toBoolean(map.get("currently_attached"));
	// record.ipConfigurationMode =
	// toIpConfigurationMode(map.get("ip_configuration_mode"));
	...
	// record.tunnelAccessPIFOf =
	// toSetOfTunnel(map.get("tunnel_access_PIF_of"));
	// record.tunnelTransportPIFOf =
	// toSetOfTunnel(map.get("tunnel_transport_PIF_of"));
	// return record;
	// }
	//
	...
	public static SR.Record toSRRecord(Object object) {
		...
		// toSetOfStorageOperations(map.get("allowed_operations"));
		// record.currentOperations =
		// toMapOfStringStorageOperations(map.get("current_operations"));
	...
	public static VBD.Record toVBDRecord(Object object) {
		...
		record.uuid = toString(map.get("uuid"));
		// record.allowedOperations =
		// toSetOfVbdOperations(map.get("allowed_operations"));
		// record.currentOperations =
		// toMapOfStringVbdOperations(map.get("current_operations"));
		...
		// record.runtimeProperties =
		// toMapOfStringString(map.get("runtime_properties"));
		// record.qosAlgorithmType = toString(map.get("qos_algorithm_type"));
		// record.qosAlgorithmParams =
		// toMapOfStringString(map.get("qos_algorithm_params"));
		// record.qosSupportedAlgorithms =
		// toSetOfString(map.get("qos_supported_algorithms"));
	...
	public static VDI.Record toVDIRecord(Object object) {
		...
		// record.residentOn = toHost(map.get("resident_on"));
		// record.allowedOperations =
		// toSetOfVdiOperations(map.get("allowed_operations"));
		// record.currentOperations =
		// toMapOfStringVdiOperations(map.get("current_operations"));
		record.SR = toSR(map.get("SR"));
	...
	public static VIF.Record toVIFRecord(Object object) {
		...
		record.uuid = toString(map.get("uuid"));
		// record.allowedOperations =
		// toSetOfVifOperations(map.get("allowed_operations"));
		// record.currentOperations =
		// toMapOfStringVifOperations(map.get("current_operations"));
		record.device = toString(map.get("device"));
		record.network = toNetwork(map.get("network"));
		record.VM = toVM(map.get("VM"));
		record.MAC = toString(map.get("MAC"));
		...
		record.statusCode = toLong(map.get("status_code"));
		record.statusDetail = toString(map.get("status_detail"));
		record.runtimeProperties = toMapOfStringString(map
	...
	public static VM.Record toVMRecord(Object object) {
		...
		record.uuid = toString(map.get("uuid"));
		record.allowedOperations = toSetOfVmOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringVmOperations(map
				.get("current_operations"));
		...
		record.actionsAfterShutdown = toOnNormalExit(map
				.get("actions_after_shutdown"));
		record.actionsAfterReboot = toOnNormalExit(map
				.get("actions_after_reboot"));
		record.actionsAfterCrash = toOnCrashBehaviour(map
				.get("actions_after_crash"));
		...
		record.lastBootCPUFlags = toMapOfStringString(map
				.get("last_boot_CPU_flags"));
		...
		// record.snapshotTime = toDate(map.get("snapshot_time"));
		// record.transportableSnapshotId =
		// toString(map.get("transportable_snapshot_id"));
		// record.blobs = toMapOfStringBlob(map.get("blobs"));
		record.tags = toSetOfString(map.get("tags"));
		// record.blockedOperations =
		// toMapOfVmOperationsString(map.get("blocked_operations"));
		...
		// toBoolean(map.get("is_snapshot_from_vmpp"));
	...
	// toVmppBackupFrequency(map.get("backup_frequency"));
	...
	// record.archiveTargetType =
	// toVmppArchiveTargetType(map.get("archive_target_type"));
	// record.archiveTargetConfig =
	// toMapOfStringString(map.get("archive_target_config"));
	// record.archiveFrequency =
	// toVmppArchiveFrequency(map.get("archive_frequency"));
	// record.archiveSchedule =
	// toMapOfStringString(map.get("archive_schedule"));
	...
	// record.nameDescription = toString(map.get("name_description"));
	// record.allowedOperations =
	// toSetOfVmApplianceOperation(map.get("allowed_operations"));
	// record.currentOperations =
	// toMapOfStringVmApplianceOperation(map.get("current_operations"));
	// record.VMs = toSetOfVM(map.get("VMs"));
	// return record;
	// }
	...
	// record.PVDriversVersion =
	// toMapOfStringString(map.get("PV_drivers_version"));
	...
	public static VMMetrics.Record toVMMetricsRecord(Object object) {
		...
		record.VCPUsUtilisation = toMapOfLongDouble(map
				.get("VCPUs_utilisation"));
	...
	// default: throw new
	// RuntimeException("Internal error in auto-generated code whilst unmarshalling event snapshot");
	// }
	// record.snapshot = b;
	// return record;
	// }
	...
	public static Host.Record toHostRecord(Object object) {
		...
		// record.memoryOverhead = toLong(map.get("memory_overhead"));
		// record.allowedOperations =
		// toSetOfHostAllowedOperations(map.get("allowed_operations"));
		// record.currentOperations =
		// toMapOfStringHostAllowedOperations(map.get("current_operations"));
		...
		// record.APIVersionVendorImplementation =
		// toMapOfStringString(map.get("API_version_vendor_implementation"));
		// record.enabled = toBoolean(map.get("enabled"));
		record.softwareVersion = toMapOfStringString(map
				.get("software_version"));
		record.otherConfig = toMapOfStringString(map.get("other_config"));
		record.capabilities = toSetOfString(map.get("capabilities"));
		record.cpuConfiguration = toMapOfStringString(map
				.get("cpu_configuration"));
		record.schedPolicy = toString(map.get("sched_policy"));
		record.supportedBootloaders = toSetOfString(map
				.get("supported_bootloaders"));
		...
		// record.licenseParams =
		// toMapOfStringString(map.get("license_params"));
		...
		// record.externalAuthServiceName =
		// toString(map.get("external_auth_service_name"));
		// record.externalAuthConfiguration =
		// toMapOfStringString(map.get("external_auth_configuration"));
		// record.edition = toString(map.get("edition"));
		// record.licenseServer =
		// toMapOfStringString(map.get("license_server"));
		// record.biosStrings = toMapOfStringString(map.get("bios_strings"));
		// record.powerOnMode = toString(map.get("power_on_mode"));
		// record.powerOnConfig =
		// toMapOfStringString(map.get("power_on_config"));
	...
	public static Network.Record toNetworkRecord(Object object) {
		...
		record.nameLabel = toString(map.get("name_label"));
		record.nameDescription = toString(map.get("name_description"));
		record.allowedOperations = toSetOfNetworkOperations(map
				.get("allowed_operations"));
		record.currentOperations = toMapOfStringNetworkOperations(map
				.get("current_operations"));
		record.VIFs = toSetOfVIF(map.get("VIFs"));
		// record.PIFs = toSetOfPIF(map.get("PIFs"));
		record.MTU = toLong(map.get("MTU"));
	...
	public static Pool.Record toPoolRecord(Object object) {
		...
		// record.haConfiguration =
		// toMapOfStringString(map.get("ha_configuration"));
		// record.haStatefiles = toSetOfString(map.get("ha_statefiles"));
		// record.haHostFailuresToTolerate =
		// toLong(map.get("ha_host_failures_to_tolerate"));
	...
	public static Pool.Status toPoolStatus(Object object) {
		...
		for (String host_ref : map.keySet()) {
			...
			Map<String, Object> hostmap = (Map<String, Object>) map
					.get(host_ref);
			...
			Map<String, Object> vmmaps = (Map<String, Object>) hostmap
					.get("VMs");
			for (String vm_ref : vmmaps.keySet()) {
				VM.Record vmrecord = new VM.Record();
				vmrecord.uuid = vm_ref;
				Map<String, Object> vmmap = (Map<String, Object>) vmmaps
						.get(vm_ref);
			...
			Map<String, Object> srmaps = (Map<String, Object>) hostmap
					.get("SRs");
			for (String sr_ref : srmaps.keySet()) {
				SR.Record srrecord = new SR.Record();
				srrecord.uuid = sr_ref;
				Map<String, Object> srmap = (Map<String, Object>) srmaps
						.get(sr_ref);
				...
				srrecord.physicalUtilisation = toLong(srmap
						.get("physical_utilisation"));
	...
	// record.afterApplyGuidance =
	// toSetOfAfterApplyGuidance(map.get("after_apply_guidance"));
	// record.otherConfig = toMapOfStringString(map.get("other_config"));
	// return record;
	// }
	...
	public static Task.Record toTaskRecord(Object object) {
		...
		record.nameLabel = toString(map.get("name_label"));
		record.nameDescription = toString(map.get("name_description"));
		record.allowedOperations = toSetOfTaskAllowedOperations(map
				.get("allowed_operations"));
		// record.currentOperations =
		// toMapOfStringTaskAllowedOperations(map.get("current_operations"));
	...
	// public static Bond toBond(Task task, Connection connection) throws
	...
	// }
	//
	// public static DRTask toDRTask(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toDRTask(parseResult(task.getResult(connection)));
	// }
	//
	// public static GPUGroup toGPUGroup(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toGPUGroup(parseResult(task.getResult(connection)));
	// }
	//
	// public static PBD toPBD(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toPBD(parseResult(task.getResult(connection)));
	// }
	//
	// public static PCI toPCI(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toPCI(parseResult(task.getResult(connection)));
	// }
	//
	// public static PGPU toPGPU(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toPGPU(parseResult(task.getResult(connection)));
	// }
	//
	// public static PIF toPIF(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toPIF(parseResult(task.getResult(connection)));
	// }
	//
	// public static PIFMetrics toPIFMetrics(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toPIFMetrics(parseResult(task.getResult(connection)));
	// }
	//
	// public static SM toSM(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toSM(parseResult(task.getResult(connection)));
	// }

	// public static SR toSR(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toSR(parseResult(task.getResult(connection)));
	// }
	//
	// public static VBD toVBD(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVBD(parseResult(task.getResult(connection)));
	// }
	//
	// public static VBDMetrics toVBDMetrics(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toVBDMetrics(parseResult(task.getResult(connection)));
	// }
	//
	// public static VDI toVDI(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVDI(parseResult(task.getResult(connection)));
	// }

	// public static VGPU toVGPU(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVGPU(parseResult(task.getResult(connection)));
	// }

	// public static VIF toVIF(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVIF(parseResult(task.getResult(connection)));
	// }
	//
	// public static VIFMetrics toVIFMetrics(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toVIFMetrics(parseResult(task.getResult(connection)));
	// }

	// public static VLAN toVLAN(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVLAN(parseResult(task.getResult(connection)));
	// }

	// public static VM toVM(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVM(parseResult(task.getResult(connection)));
	// }

	// public static VMPP toVMPP(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVMPP(parseResult(task.getResult(connection)));
	// }

	// public static VMAppliance toVMAppliance(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toVMAppliance(parseResult(task.getResult(connection)));
	// }

	// public static VMGuestMetrics toVMGuestMetrics(Task task, Connection
	// connection) throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toVMGuestMetrics(parseResult(task.getResult(connection)));
	// }

	// public static VMMetrics toVMMetrics(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toVMMetrics(parseResult(task.getResult(connection)));
	// }

	// public static VTPM toVTPM(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toVTPM(parseResult(task.getResult(connection)));
	// }

	// public static Blob toBlob(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toBlob(parseResult(task.getResult(connection)));
	// }

	// public static Console toConsole(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toConsole(parseResult(task.getResult(connection)));
	// }

	// public static Crashdump toCrashdump(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toCrashdump(parseResult(task.getResult(connection)));
	// }

	// public static Host toHost(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toHost(parseResult(task.getResult(connection)));
	// }
	//
	// public static HostCpu toHostCpu(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toHostCpu(parseResult(task.getResult(connection)));
	// }

	// public static HostCrashdump toHostCrashdump(Task task, Connection
	// connection) throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toHostCrashdump(parseResult(task.getResult(connection)));
	// }

	// public static HostMetrics toHostMetrics(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toHostMetrics(parseResult(task.getResult(connection)));
	// }

	// public static HostPatch toHostPatch(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toHostPatch(parseResult(task.getResult(connection)));
	// }
	//
	// public static Message toMessage(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toMessage(parseResult(task.getResult(connection)));
	// }

	// public static Network toNetwork(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toNetwork(parseResult(task.getResult(connection)));
	// }
	//
	// public static Pool toPool(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toPool(parseResult(task.getResult(connection)));
	// }

	// public static PoolPatch toPoolPatch(Task task, Connection connection)
	// throws XenAPIException, BadServerResponse, XmlRpcException,
	// BadAsyncResult{
	// return Types.toPoolPatch(parseResult(task.getResult(connection)));
	// }

	// public static Role toRole(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toRole(parseResult(task.getResult(connection)));
	// }
	//
	// public static Secret toSecret(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toSecret(parseResult(task.getResult(connection)));
	// }

	// public static Session toSession(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toSession(parseResult(task.getResult(connection)));
	// }

	// public static Subject toSubject(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toSubject(parseResult(task.getResult(connection)));
	// }

	// public static Task toTask(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toTask(parseResult(task.getResult(connection)));
	// }

	// public static Tunnel toTunnel(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
	// return Types.toTunnel(parseResult(task.getResult(connection)));
	// }

	// public static User toUser(Task task, Connection connection) throws
	// XenAPIException, BadServerResponse, XmlRpcException, BadAsyncResult{
